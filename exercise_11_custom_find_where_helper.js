...
// The object { ladders: '20 feet' } should be used as the search criteria - we would want to find a ladder whose 'height' 
...
// For example, Object.keys({ height: '20 feet' }) would return 'height'.  You could then check to see 
// if a given element in the array had a property equal to the criteria's value with something 
// like element[property] === criteria[property].
